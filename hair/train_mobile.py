...
# Load pre-trained MobileNetV2 model and modify it for 10 classes
from torchvision.models import MobileNet_V2_Weights

weights = MobileNet_V2_Weights.IMAGENET1K_V1  # Use updated weights
model = models.mobilenet_v2(weights=weights)
model.classifier[1] = nn.Linear(model.last_channel, 10)  # Assuming 10 disease classes
...
train_accuracies, val_accuracies = [], []  # Fixed here
...
# Testing the model
model.load_state_dict(torch.load('mobilenet.pth'))  # Load the best model
model.eval()
test_correct = 0
test_total = 0
